                                                    ...
                                                    <tr>
                                                        ...
                                                        for ($j = 0; $j < count($dep['interval']); $j++) {
                                                            ...
                                                            while ($i < count($a)) {
                                                                ...
                                                                $TotSaison1 += $filtre_interval[$i]['salaireTotale']['haute']  * $saison['days'];
                                                            ...
                                                            <td style="text-align: right">
                                                                ...
                                                                if (sizeof($filtre_interval) != 0) {
                                                                    ...
                                                                    <div class="form-group row ">
                                                                        <label class="control-label col-md-12 col-sm-3 "><?php echo number_format($filtre_interval[$x]['salaireTotale']['haute']  * $saison['days'], 3, ',', ','); ?></label>
                                                                    </div>
